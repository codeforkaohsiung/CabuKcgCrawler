...
class JSONWritePipeline(object):
	...
	def process_item(self, item, spider):
		if 'JSONWritePipeline' not in getattr(spider, 'pipelines'):
			log.msg('[JSONWritePipeline] Skip', level=log.DEBUG)
			return item

		log.msg('[JSONWritePipeline] Process...', level=log.DEBUG)
	...
	def close_spider(self, spider):
		log.msg('[JSONWritePipeline] spider is close.', level=log.INFO)
